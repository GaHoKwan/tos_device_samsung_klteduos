...
.method private isDataAllowedOnDataDisabled(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    iget-boolean v9, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mNeedRoamingDataSelctionPopup:Z
    ...
    .line 5183
    const-string v8, "isDataAllowedOnDataDisabled: not allowed in case of doemstic in Oversea"
...
.method private trySetupData(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    .line 1188
    const-string v9, "persist.sys.dataprefer.simid"
    ...
    invoke-static {v9}, Lcom/android/internal/telephony/MultiSimManager;->getPhysicalSimSlot(I)I
    ...
    .line 1191
    const-string v9, "trySetupData: dataPrefered is not same."
    ...
    const-string v10, "trySetupData: reject trySetupData, "
    ...
    const-string v10, "trysetup for preprocess: salesCode= "
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/dataconnection/DcTracker;->preProcessDataConnection(Ljava/lang/String;)Z
    ...
    .line 1292
    const-string v9, "preProcessDataConnection called: false"
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->isCdmaRat(I)Z
    ...
    const-string v10, "trySetupData: X IMS reject bcz of RAT="
    ...
    .line 1316
    .local v5, "radioTechnology":I
    iget-object v9, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPhone:Lcom/android/internal/telephony/PhoneBase;

    invoke-virtual {v9}, Lcom/android/internal/telephony/PhoneBase;->getServiceState()Landroid/telephony/ServiceState;

    invoke-static {v5}, Landroid/telephony/ServiceState;->isDataInLegacy3gpp(I)Z
    ...
    .line 1318
    const-string v9, "Reject IMS Type in 3GPP legacy"
    ...
    .line 1323
    .end local v5    # "radioTechnology":I
    :cond_4
    iget-object v9, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPhone:Lcom/android/internal/telephony/PhoneBase;
    ...
    .line 1336
    .local v2, "isDataAllowedByItsOn":Z
    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;
    ...
    .line 1337
    iget-object v9, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mApi:Lcom/itsoninc/android/ItsOnOemApi;
    ...
    invoke-virtual {v9, v10, v11, v12}, Lcom/itsoninc/android/ItsOnOemApi;->isDataAllowed(JLjava/lang/String;)Z
    ...
    const-string v10, "itson: isDataAllowedByItsOn = "
    ...
    .line 1362
    :cond_a
    invoke-virtual {p1, v8}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setWaitingApns(Ljava/util/ArrayList;)V
    ...
    const-string v10, "trySetupData: Create from mAllApnSettings : "
    ...
    const-string v10, "trySetupData: call setupData, waitingApns : "
...
.method public UpdateIccRecords(Z)V
    ...
    .line 4341
    invoke-static {}, Lcom/android/internal/telephony/MultiSimManager;->isNetworkTypeLTEorEHRPD()Z
...
.method public dispose()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/internal/telephony/ServiceStateTracker;->unregisterForPlmnChanged(Landroid/os/Handler;)V
    ...
    .line 448
    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mTelephonyManager:Landroid/telephony/MultiSimTelephonyManager;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/telephony/MultiSimTelephonyManager;->listen(Landroid/telephony/PhoneStateListener;I)V
...
.method public getOverallState()Lcom/android/internal/telephony/DctConstants$State;
    ...
    .line 684
    :cond_1
    sget-object v6, Lcom/android/internal/telephony/dataconnection/DcTracker$3;->$SwitchMap$com$android$internal$telephony$DctConstants$State:[I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 3825
    .local v6, "msimm":Ljava/lang/String;
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "handleMessage: EVENT_RECORDS_LOADED. So set data preferred by MSIMM, dataPreferSimId = "
    ...
    check-cast v5, Landroid/net/MultiSimConnectivityManager;

    .line 3827
    .local v5, "mConnManager":Landroid/net/MultiSimConnectivityManager;
    const-string v8, "0"
    ...
    .line 3830
    invoke-virtual {v5}, Landroid/net/MultiSimConnectivityManager;->switchToSim2DataNetwork()V
    ...
    .end local v5    # "mConnManager":Landroid/net/MultiSimConnectivityManager;
    .end local v6    # "msimm":Ljava/lang/String;
    :cond_4
    :goto_1
    ...
    .line 3834
    .restart local v1    # "dataPreferSimId":Ljava/lang/String;
    .restart local v3    # "iccType":Ljava/lang/String;
    .restart local v4    # "iccType_1":Ljava/lang/String;
    .restart local v5    # "mConnManager":Landroid/net/MultiSimConnectivityManager;
    .restart local v6    # "msimm":Ljava/lang/String;
    :cond_5
    const-string v8, "1"
    ...
    .line 3835
    invoke-virtual {v5}, Landroid/net/MultiSimConnectivityManager;->switchToSim1DataNetwork()V
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    invoke-direct {p0, v7, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->cleanUpConnection(ZLcom/android/internal/telephony/dataconnection/ApnContext;)V
    ...
    .end local v7    # "tearDown":Z
    :sswitch_c
    const-string v8, "EVENT_ENABLE_DATA_SWITCH_READY"
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->onChangeVoiceDomain(I)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->onVoiceDomainDone(I)V
...
.method protected onChangeVoiceDomain(I)V
    .locals 4
    .param p1, "isVoiceDomainOnly"    # I
    ...
    invoke-virtual {p0, v3, p1, v1}, Lcom/android/internal/telephony/dataconnection/DcTracker;->obtainMessage(III)Landroid/os/Message;

    move-result-object v1

    invoke-interface {v2, v0, v1}, Lcom/android/internal/telephony/CommandsInterface;->setVoiceDomainPref(ILandroid/os/Message;)V
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/dataconnection/DcFailCause;->isPeramanentFailVzw()Z
    ...
    .line 2808
    invoke-virtual {v3}, Lcom/android/internal/telephony/dataconnection/ApnContext;->getPermanentRetryCount()I
    ...
    invoke-virtual {v3, v0}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setPermanentRetryCount(I)V
...
.method protected onVoLteOn(ZZ)V
    .locals 7
    .param p1, "isVoLteOn"    # Z
    .param p2, "isVoiceDomainOnly"    # Z
    ...
    const-string v5, "onVoLteOn: isVoLteOn= "
    ...
    const-string v5, " isVoiceDomainOnly= "
    ...
    const-string v5, "onVoLteOn: apnContext(ims) state="
    ...
    invoke-static {v2, v5}, Lcom/samsung/commonimsinterface/imsinterface/CommonIMSInterface;->getInstance(ILandroid/content/Context;)Ljava/lang/Object;
    ...
    :goto_1
    invoke-virtual {p0, v6, v2, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->obtainMessage(III)Landroid/os/Message;

    move-result-object v2

    invoke-direct {p0, v3, v2}, Lcom/android/internal/telephony/dataconnection/DcTracker;->notifyChangeProfileReqToRIL(ILandroid/os/Message;)V
    ...
    :goto_3
    invoke-virtual {p0, v6, v3, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->obtainMessage(III)Landroid/os/Message;
    ...
    .line 5080
    :cond_6
    iput-boolean v3, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mVolteTurnOff:Z
...
.method protected onVoiceCallEnded()V
    ...
    .line 3124
    const-string v4, "onVoiceCallEnded"
    ...
    .line 3131
    const-string v4, "onVoiceCallEnded - all simslot"
    ...
    const-string v7, "onVoiceCallEnded - sim : "
    ...
    .line 3141
    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->startDataStallAlarm(Z)V

    .line 3143
    const-string v4, "2GVoiceCallEnded"

    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->notifyDataConnection(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4}, Lcom/android/internal/telephony/dataconnection/DcTracker;->setupDataOnConnectableApns(Ljava/lang/String;)V
    ...
    .line 3161
    iget-boolean v4, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPollingStopped:Z

    if-eqz v4, :cond_9

    .line 3162
    iput-boolean v5, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPollingStopped:Z
...
.method protected onVoiceDomainDone(I)V
    .locals 4
    .param p1, "isVoiceDomainOnly"    # I
