...
.method public final execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    .line 530
    .local v18, "execContext":Lorg/apache/http/protocol/HttpContext;
    const/16 v17, 0x0

    .line 534
    .local v17, "director":Lorg/apache/http/client/RequestDirector;
    monitor-enter p0
    ...
    .line 537
    .local v16, "defaultContext":Lorg/apache/http/protocol/HttpContext;
    if-nez p3, :cond_2
    ...
    invoke-virtual {v9}, Lorg/apache/http/protocol/BasicHttpProcessor;->copy()Lorg/apache/http/protocol/BasicHttpProcessor;
    ...
    invoke-virtual/range {v3 .. v15}, Lorg/apache/http/impl/client/AbstractHttpClient;->createClientRequestDirector(Lorg/apache/http/protocol/HttpRequestExecutor;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/ConnectionReuseStrategy;Lorg/apache/http/conn/ConnectionKeepAliveStrategy;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/protocol/HttpProcessor;Lorg/apache/http/client/HttpRequestRetryHandler;Lorg/apache/http/client/RedirectHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/AuthenticationHandler;Lorg/apache/http/client/UserTokenHandler;Lorg/apache/http/params/HttpParams;)Lorg/apache/http/client/RequestDirector;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 556
    .end local v17    # "director":Lorg/apache/http/client/RequestDirector;
    .local v7, "director":Lorg/apache/http/client/RequestDirector;
    :try_start_1
    monitor-exit p0
    :try_end_1
    ...
    .line 563
    new-instance v3, Lorg/apache/http/impl/client/secgbaclient/nafclient/NafRequest;

    invoke-virtual/range {p0 .. p0}, Lorg/apache/http/impl/client/AbstractHttpClient;->getParams()Lorg/apache/http/params/HttpParams;
    ...
    invoke-direct {v3, v4}, Lorg/apache/http/impl/client/secgbaclient/nafclient/NafRequest;-><init>(Ljava/lang/String;)V

    .line 564
    .local v3, "nafRequest":Lorg/apache/http/impl/client/secgbaclient/nafclient/NafRequest;
    invoke-virtual/range {p0 .. p0}, Lorg/apache/http/impl/client/AbstractHttpClient;->getParams()Lorg/apache/http/params/HttpParams;
    ...
    invoke-virtual/range {v3 .. v8}, Lorg/apache/http/impl/client/secgbaclient/nafclient/NafRequest;->createAndSendRequest(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpHost;Lorg/apache/http/protocol/HttpContext;Lorg/apache/http/client/RequestDirector;Ljava/lang/String;)Lorg/apache/http/HttpResponse;

    move-result-object v4

    .line 570
    .end local v3    # "nafRequest":Lorg/apache/http/impl/client/secgbaclient/nafclient/NafRequest;
    :goto_1
    return-object v4

    .line 540
    .end local v7    # "director":Lorg/apache/http/client/RequestDirector;
    .restart local v17    # "director":Lorg/apache/http/client/RequestDirector;
    :cond_2
    :try_start_2
    new-instance v19, Lorg/apache/http/protocol/DefaultedHttpContext;
    ...
    .end local v18    # "execContext":Lorg/apache/http/protocol/HttpContext;
    ...
    .restart local v18    # "execContext":Lorg/apache/http/protocol/HttpContext;
    goto/16 :goto_0

    .line 556
    .end local v16    # "defaultContext":Lorg/apache/http/protocol/HttpContext;
    :catchall_0
    move-exception v4
    ...
    .end local v17    # "director":Lorg/apache/http/client/RequestDirector;
    .restart local v7    # "director":Lorg/apache/http/client/RequestDirector;
    :goto_2
    :try_start_3
    monitor-exit p0
    :try_end_3
    ...
    .line 570
    .restart local v16    # "defaultContext":Lorg/apache/http/protocol/HttpContext;
    :cond_3
    :try_start_4
    ...
    invoke-interface {v7, v0, v1, v2}, Lorg/apache/http/client/RequestDirector;->execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    :try_end_4
    ...
    .line 572
    .local v20, "httpException":Lorg/apache/http/HttpException;
    ...
    .line 556
    .end local v16    # "defaultContext":Lorg/apache/http/protocol/HttpContext;
    .end local v20    # "httpException":Lorg/apache/http/HttpException;
    :catchall_1
    move-exception v4
