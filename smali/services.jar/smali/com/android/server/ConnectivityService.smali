...
.method private internalSwitchDataNetwork(I)V
    ...
    .line 1980
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->isSwitching:Z

    if-ne v0, v1, :cond_1

    .line 1981
    const-string v0, "Now, DDS is changing. So it will be failed"
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/ConnectivityService;->onSwitchDataNetworkCallback(IZ)V
    ...
    .line 1985
    :cond_1
    const-string v0, "isSwitching will be set as true"

    invoke-static {v0}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 1986
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->isSwitching:Z
...
.method private routeTableFlush(Z)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZ)V
...
.method public getMobileDataEnabled()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/ConnectivityService;->getMobileDataEnabledEx(I)Z
...
.method public onSwitchDataNetworkCallback(IZ)V
    ...
    .line 2040
    :cond_0
    const-string v4, "Switching done. isSwitching will be set as false"

    invoke-static {v4}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 2041
    iput-boolean v7, p0, Lcom/android/server/ConnectivityService;->isSwitching:Z
...
.method public switchDataNetwork(I)V
    ...
    iput v2, p0, Lcom/android/server/ConnectivityService;->mBackupDataPreferSimId:I
    ...
    const-string v2, "android.net.conn.DATA_CONNECTION_CHANGE_SUCCESS"
