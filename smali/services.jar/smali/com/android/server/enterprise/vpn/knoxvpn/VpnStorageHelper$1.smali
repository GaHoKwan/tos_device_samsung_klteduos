...
.method public onTableFound(Lcom/android/server/enterprise/storage/Table;)V
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->isTableExists(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->preTableCreate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)V
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->createTable(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)V
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->postTableCreate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)V
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->preTableUpdate(Landroid/database/sqlite/SQLiteDatabase;Lcom/android/server/enterprise/storage/Table;)Z
    ...
    # invokes: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->getMissingColumns(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lcom/android/server/enterprise/storage/Table;)Ljava/util/ArrayList;
    ...
    :cond_2
    :try_start_1
    # getter for: Lcom/android/server/enterprise/vpn/knoxvpn/VpnStorageHelper;->DBG:Z
