...
.method public onChangeMotionSettings(II)V
    ...
    invoke-static {v2, v1, v6}, Landroid/hardware/motion/MotionRecognitionService;->access$1600(Landroid/hardware/motion/MotionRecognitionService;IZ)V

    .line 432
    iget-object v2, p0, Landroid/hardware/motion/MotionRecognitionService$4;->this$0:Landroid/hardware/motion/MotionRecognitionService;

    # getter for: Landroid/hardware/motion/MotionRecognitionService;->mLockEngine:Ljava/lang/Object;
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$1700(Landroid/hardware/motion/MotionRecognitionService;)Ljava/lang/Object;
    ...
    invoke-static {v2, v1, v4}, Landroid/hardware/motion/MotionRecognitionService;->access$1800(Landroid/hardware/motion/MotionRecognitionService;IZ)V
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$400(Landroid/hardware/motion/MotionRecognitionService;)Z
    ...
    invoke-static {v4, v5}, Landroid/hardware/motion/MotionRecognitionService;->access$500(Landroid/hardware/motion/MotionRecognitionService;I)Z
    ...
    # invokes: Landroid/hardware/motion/MotionRecognitionService;->useSensor(IZ)V
    invoke-static {v2, v1, v7}, Landroid/hardware/motion/MotionRecognitionService;->access$1600(Landroid/hardware/motion/MotionRecognitionService;IZ)V
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$900(Landroid/hardware/motion/MotionRecognitionService;)Landroid/hardware/motion/MotionRecognitionSettings;
