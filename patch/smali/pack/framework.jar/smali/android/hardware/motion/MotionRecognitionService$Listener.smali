...
.method public binderDied()V
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$000(Landroid/hardware/motion/MotionRecognitionService;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$2110(Landroid/hardware/motion/MotionRecognitionService;)I

    .line 1312
    iget-object v2, p0, Landroid/hardware/motion/MotionRecognitionService$Listener;->this$0:Landroid/hardware/motion/MotionRecognitionService;

    # getter for: Landroid/hardware/motion/MotionRecognitionService;->mrefSmartScroll:I
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$2100(Landroid/hardware/motion/MotionRecognitionService;)I
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$1300(Landroid/hardware/motion/MotionRecognitionService;)Landroid/hardware/motion/MotionRecognitionSmartFace;
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$310(Landroid/hardware/motion/MotionRecognitionService;)I
    ...
    invoke-static {v2, v4}, Landroid/hardware/motion/MotionRecognitionService;->access$500(Landroid/hardware/motion/MotionRecognitionService;I)Z
    ...
    invoke-static {v2, v4}, Landroid/hardware/motion/MotionRecognitionService;->access$402(Landroid/hardware/motion/MotionRecognitionService;Z)Z
    ...
    # getter for: Landroid/hardware/motion/MotionRecognitionService;->mListeners:Ljava/util/ArrayList;
    invoke-static {v5}, Landroid/hardware/motion/MotionRecognitionService;->access$000(Landroid/hardware/motion/MotionRecognitionService;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Landroid/hardware/motion/MotionRecognitionService;->access$2300(Landroid/hardware/motion/MotionRecognitionService;)V
...
.method public callback(Landroid/hardware/motion/MREvent;)V
    ...
    invoke-static {v6}, Landroid/hardware/motion/MotionRecognitionService;->access$2400(Landroid/hardware/motion/MotionRecognitionService;)Z
    ...
    invoke-static {v6}, Landroid/hardware/motion/MotionRecognitionService;->access$2500(Landroid/hardware/motion/MotionRecognitionService;)Landroid/content/Context;
