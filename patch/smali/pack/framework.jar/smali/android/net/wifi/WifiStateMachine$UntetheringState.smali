...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$41500(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiStateMachine;->access$38602(Landroid/net/wifi/WifiStateMachine;I)I

    .line 8961
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine$UntetheringState;->this$0:Landroid/net/wifi/WifiStateMachine;

    # getter for: Landroid/net/wifi/WifiStateMachine;->mPreviousTetherData:I
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$41700(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0, v4}, Landroid/net/wifi/WifiStateMachine;->access$41702(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->log(Ljava/lang/String;)V
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateMachine;->access$41800(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$40200(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$39100(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v2

    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$41900(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$40100(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$42000(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$42100(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v1, p1}, Landroid/net/wifi/WifiStateMachine;->access$42200(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
